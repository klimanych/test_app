...
use Src\Products\Http\Controllers\ShowProduct\ShowProductPageController;
...
Route::group(['middleware' => ['web'], 'prefix' => 'products', 'as' => 'products.'], function() {
    ...
    Route::get('/{id}', EditProductPageController::class)->middleware(['can-edit-product'])->name('edit-page');
    Route::post('/{id}', UpdateProductController::class)->middleware(['can-edit-product'])->name('update');
